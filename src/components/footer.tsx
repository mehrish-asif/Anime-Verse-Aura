    ...
    return (
        <>
            <div className="flex flex-col">
                <footer className='w-full bg-gray-950 border-t border-gray-900 text-white py-8 px-6 mt-auto mb-10'>
                    ...
                    <div className="fixed bottom-0 z-100 w-full bg-black border-t border-gray-900 text-xs md:text-base text-white px-6 py-4 flex justify-center gap-4">
