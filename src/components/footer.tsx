        ...
        <div className="flex flex-col">
            <footer className='w-full bg-gray-950 border-t border-gray-900 text-white py-8 px-6 mt-auto'>
                <div className="max-w-6xl mx-auto flex flex-col justify-center items-center mt-6">
                    <img src="/Image/AnimeVerseAura.jpg" alt="" style={{ borderRadius: "50%", width: "80px", height: "75px" }} /> <br />

                    <h1 className='text-2xl md:text-5xl text-cyan-500'>AnimeVerseAura</h1>

                    <p className='mt-6 text-purple-300 text-center'>Step into a vibrant world of anime where every card tells a story. From fierce battles to heart-touching tales, our site curates the best titles with crisp details, ratings, and watch guides—all wrapped in a sleek, modern design made for true fans.</p>
                </div>
                <div className='flex flex-col justify-center items-center mt-6'>
                    <h1 className='text-2xl md:text-4xl text-aliceblue'>Contact Us</h1>
                ...
                <div className='w-full  bg-black border-t border-gray-900 text-white mt-6 px-6 py-4 flex justify-center gap-6'>
