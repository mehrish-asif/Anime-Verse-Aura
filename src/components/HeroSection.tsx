    ...
    return (
        <div className='h-auto mt-20 md:h-[50rem] w-full rounded-md flex flex-col item-center justify-center relative overflow-hidden mx-auto py-10 md:py-0 ' >
            <div className='p-4 relative z-10 w-full text-center' >
                ...
                >Explore more about Animes</h1>
                <p
                    className='mt-4 font-normal text-base md:text-lg text-neutral-300 max-w-lg mx-auto'
                >Experience anime like never before – action, drama, fantasy, all in one spot. Join the world of heroes, magic, and adventure – your anime journey starts here.</p>
